        ...
        <div className='row'>
          <div className='col-lg-5 col-md-5'>
            <div className='abot1'>
              <ul>
                <li>
                  <Link to='/service'><img src='./vijenderkumargour.github.io/img/about-img-1.jpg' alt='abt-1' /></Link>
                ...
                <li>
                  <Link to='/service'><img src='./vijenderkumargour.github.io/img/about-img-2.jpg' alt='abt-1' /></Link>
                  <div className='about-text'>
                    <h3>Michel Brown</h3>
                    <p>Communicator</p>
                  </div>
                ...
                <li>
                  <Link to='/service'><img src='./vijenderkumargour.github.io/img/about-img-3.jpg' alt='abt-1' /></Link>
                  <div className='about-text'>
                    <h3>Michel Brown</h3>
                    <p>Communicator</p>
                  </div>
                ...
                <li>
                  <Link to='/service'><img src='./vijenderkumargour.github.io/img/about-img-4.jpg' alt='abt-1' /></Link>
                  <div className='about-text'>
                    <h3>Michel Brown</h3>
                    <p>Communicator</p>
                  </div>
          ...
          <div className='col-lg-7 col-md-7'>
            <div className='abt2'>
              <h4>BECOME A VOLUNTEER asdfsfd asdfasf?</h4>
